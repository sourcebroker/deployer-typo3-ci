...
if [ "$BRANCH" = "main" ] || [ "$BRANCH" = "master" ]; then
  ...
  awk -v new_tag="$NEW_TAG" '{gsub(/sourcebroker\/deployer-typo3-ci\/[^\/]*/, "sourcebroker/deployer-typo3-ci/" new_tag)}1' ci/provider/gitlab/main.yml > ci/provider/gitlab/main.tmp && mv ci/provider/gitlab/main.tmp ci/provider/gitlab/main.yml
